...
function AppAutenticada() {
  ...
  // El rol viene resuelto del servidor y decide a qué panel entra cada uno.
  // Es la pieza que conecta la autenticación con la separación docente /
  // estudiante: sin él, el router manda a todos al panel de estudiante.
  const user: User = {
