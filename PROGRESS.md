...
- [x] `convex/schema.ts` con 6 tablas en español
...
- [ ] Agregar tablas en inglés (`Learning_Progress`, `Peer_Profile`, `Sessions`, etc.)
...
|---|-------|-----------|---------|
| 1 | `instruccion` | Gestión de roles/niveles educativos | `por_nombre` |
| 2 | `usuario` | Datos de usuarios de la plataforma | `por_email`, `por_es_st` |
| 3 | `curso` | Cursos disponibles | `por_c_grado` |
| 4 | `modulos` | Contenido desglosado por curso | `por_c_curso` |
| 5 | `materiales` | Recursos educativos por módulo | `por_c_mod` |
| 6 | `matricula` | Relación usuario ↔ curso (inscripción) | `por_c_usuario`, `por_c_curso` |
...
### ⏱️ Tiempo empleado: ~30 min
### ⏱️ Tiempo restante: ~11.5 horas
